...
public partial class ChemicalEquationBalancer
{
    ...
    private ChemicalBalanceResult _result = Blog.Blazor.Core.ChemicalEquationBalancer.Balance(
        "Fe + O2 → Fe2O3"
    );
    ...
    {
        _result = Blog.Blazor.Core.ChemicalEquationBalancer.Balance(_equationText);
        _tablePending = true;
    }
