...
public partial class LanguageList
{
    ...
    protected override async Task<List<Language>> LoadEntitiesAsync(BlogAdminDbContext dbContext) =>
        await dbContext
    ...
    protected override Task<Language?> FindTrackedAsync(BlogAdminDbContext dbContext, int id) =>
