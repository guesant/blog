...
public partial class FindingList
{
    ...
    protected override async Task<List<Resource>> LoadEntitiesAsync(BlogAdminDbContext dbContext) =>
        await dbContext
    ...
    protected override Task<Resource?> FindTrackedAsync(BlogAdminDbContext dbContext, int id) =>
    ...
    protected override async Task RemoveAsync(BlogAdminDbContext dbContext, Resource tracked)
    {
