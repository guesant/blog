...
internal static class GraphQueries
{
    ...
    internal static List<TopicEdgeRow> TopicEdges(PortfolioPublicDbContext db) =>
        db
    ...
    internal static List<CollectionEdgeRow> CollectionEdges(PortfolioPublicDbContext db) =>
        db
    ...
    internal static List<RelationEdgeRow> RelationEdges(PortfolioPublicDbContext db) =>
        (
