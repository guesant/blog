...
public partial class PageList
{
    ...
    protected override async Task<List<Page>> LoadEntitiesAsync(BlogAdminDbContext dbContext) =>
        await dbContext
    ...
    protected override Task<Page?> FindTrackedAsync(BlogAdminDbContext dbContext, int id) =>
