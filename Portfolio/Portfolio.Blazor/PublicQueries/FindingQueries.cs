...
{
    internal static List<FindingRow> Findings(PortfolioPublicDbContext db, string locale) =>
        (
    ...
    internal static List<FindingLinkRow> Links(PortfolioPublicDbContext db) =>
        (
    ...
    internal static List<IdentifierRow> Identifiers(PortfolioPublicDbContext db) =>
        (
    ...
    internal static List<AttributionRow> AttributionTopics(
