        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nda = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    published_at = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    show_history = table.Column<bool>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: false
                    )
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    is_automatic = table.Column<bool>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    contact_available = table.Column<bool>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_iso = table.Column<DateTime>(type: "TEXT", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    show_history = table.Column<bool>(
                        type: "INTEGER",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    published_date_iso = table.Column<string>(type: "TEXT", nullable: true),
                    found_date_iso = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reference_collection_translations_reference_collections_reference_collection_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reference_collection_item_reference_collections_reference_collection_id",
                        column: x => x.reference_collection_id,
                        principalTable: "reference_collections",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
