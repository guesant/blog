...
using ResumeEntity = Blog.Blazor.Data.Entities.Resume;
using ResumeTranslationEntity = Blog.Blazor.Data.Entities.ResumeTranslation;

namespace Blog.Blazor.Components.Admin.Pages.Resume;
