...
namespace Blog.Blazor.Components.Admin.Pages.Projects;
...
public partial class ProjectList
{
    ...
    protected override async Task<List<Project>> LoadEntitiesAsync(BlogAdminDbContext dbContext) =>
        await dbContext
    ...
    protected override Task<Project?> FindTrackedAsync(BlogAdminDbContext dbContext, int id) =>
