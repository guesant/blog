...
namespace Portfolio.Blazor.Components.Admin.Pages.NavItems;
...
public partial class NavItemList
{
    ...
    protected override async Task<List<NavItem>> LoadEntitiesAsync(
