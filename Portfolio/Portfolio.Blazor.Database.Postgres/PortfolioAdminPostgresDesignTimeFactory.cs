...
namespace Portfolio.Blazor.Database.Postgres;

public sealed class PortfolioAdminPostgresDesignTimeFactory
            ...
            .UseNpgsql(
                ...
                npgsql =>
                    npgsql.MigrationsAssembly(
                        typeof(PortfolioAdminPostgresDesignTimeFactory).Assembly.GetName().Name
                    )
            )
            .Options;
