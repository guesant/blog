...
using Blog.Blazor.PublicQueries;
...
) : IPublicSiteContentProvider
{
    ...
    private PublicSiteSnapshot Build(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicProject> Projects(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicCaseStudy> Cases(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicWriting> Writings(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicFinding> Findings(BlogPublicDbContext context, string locale)
    {
        var topics = TopicQueries
    ...
    private static List<PublicCollection> Collections(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicExperiment> Experiments(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicSnippet> Snippets(BlogPublicDbContext context, string locale)
    {
    ...
    private static List<PublicCredit> Credits(BlogPublicDbContext context, string locale) =>
        CreditQueries
            .Credits(context, locale)
    ...
    private string Copyright(BlogPublicDbContext context, int siteId, string name, string locale)
    {
        var template =
    ...
    private static PublicNavigation Navigation(BlogPublicDbContext context, string locale)
    {
