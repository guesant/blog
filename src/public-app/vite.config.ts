    ...
    tanstackStart({
      router: {
        routeFileIgnorePattern:
          '^(?:site-route-(?:context|loader|head)\\.(?:tsx|ts)|site--locale-layout\\.tsx|splat-(?:request-for-path|metadata-for-route)\\.tsx|splat-metadata-(?:content|default|first-text|kind|localized|page|article)\\.ts|splat-detail-route-path\\.ts|splat--splat-route\\.tsx)$',
      },
    }),
    viteReact(),
  ],
