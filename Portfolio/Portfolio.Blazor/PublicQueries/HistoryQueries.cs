...
{
    internal static List<HistoryRow> ForProjects(PortfolioPublicDbContext db, string locale) =>
        Translated(
            db,
    ...
    internal static List<HistoryRow> ForCaseStudies(PortfolioPublicDbContext db, string locale) =>
        Translated(
            db,
    ...
    internal static List<HistoryRow> ForWritings(PortfolioPublicDbContext db, string locale) =>
        Translated(
            db,
    ...
    internal static List<HistoryRow> ForExperiments(PortfolioPublicDbContext db, string locale) =>
        Translated(
            db,
    ...
    internal static List<HistoryRow> ForSnippets(PortfolioPublicDbContext db, string locale) =>
        Translated(
            db,
    ...
    internal static List<HistoryRow> ForSnippetFiles(PortfolioPublicDbContext db) =>
        Translated(
            db,
