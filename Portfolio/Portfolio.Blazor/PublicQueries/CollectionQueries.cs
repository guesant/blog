...
{
    internal static List<CollectionRow> Collections(PortfolioPublicDbContext db, string locale) =>
        (
    ...
    internal static List<CollectionItemRow> Items(PortfolioPublicDbContext db, string locale) =>
        (
