...
use App\ReadModel\PublicSite\Content\ResourceReader;
use Tests\TestCase;
...
class ResourceReaderTest extends TestCase
{
    public function test_find_by_slug_returns_resource_with_relations(): void
    {
        ...
        $result = (new ResourceReader)->findBySlug('resource-a', 'en');
    ...
    public function test_inbound_relations_use_correct_label(): void
    {
        ...
        $result = (new ResourceReader)->findBySlug('resource-b', 'en');
