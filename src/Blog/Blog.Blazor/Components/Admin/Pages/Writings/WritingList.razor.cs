...
namespace Blog.Blazor.Components.Admin.Pages.Writings;

public partial class WritingList
{
    protected override string EntityLabel => "writing";

    protected override async Task<List<Writing>> LoadEntitiesAsync(BlogAdminDbContext dbContext) =>
        await dbContext
    ...
    protected override Task<Writing?> FindTrackedAsync(BlogAdminDbContext dbContext, int id) =>
    ...
    protected override async Task RemoveAsync(BlogAdminDbContext dbContext, Writing tracked)
    {
