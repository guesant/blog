...
use App\Application\PublicSite\DownloadPublicSnippetQuery;
use App\Application\PublicSite\DownloadPublicSnippetQueryHandler;
...
class SnippetDownloadController extends Controller
{
    ...
    public function __invoke(Request $request, string $slug, DownloadPublicSnippetQueryHandler $handler): Response
    {
        try {
            $result = $handler->handle(new DownloadPublicSnippetQuery(
                slug: $slug,
