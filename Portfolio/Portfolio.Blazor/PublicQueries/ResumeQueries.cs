...
{
    internal static ResumeRow? Resume(PortfolioPublicDbContext db, string locale) =>
        (
    ...
    internal static List<string> SelectedCaseSlugs(PortfolioPublicDbContext db, int resumeId) =>
        (
