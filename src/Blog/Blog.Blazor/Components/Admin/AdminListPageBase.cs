    ...
    where TEntity : class
{
    ...
    protected abstract Task<List<TEntity>> LoadEntitiesAsync(BlogAdminDbContext dbContext);
    protected abstract Task<TEntity?> FindTrackedAsync(BlogAdminDbContext dbContext, int id);
    ...
    protected virtual Task RemoveAsync(BlogAdminDbContext dbContext, TEntity tracked)
    {
